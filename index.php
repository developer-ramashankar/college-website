...
<html lang="en">
  <head>
    ...
    <title>SNSY Inter College</title> <?php include("./include/stylesheet.php") ?>
  ...
  <body>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner"> <?php include('./include_element/slider.php')?> </div>
    ...
    <section class="tf__blog pt_110 xs_pt_75 pb_100 xs_pb_60" style="background: url(images/blog_bg.jpg);">
      <div class="container">
        ...
        <div class="row blog_slider"> <?php include('./include_element/gallery.php')?> </div>
      </div>
      </div>
    </section>
    <!--==============================
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1s">
            <div class="tf__about_us_text">
              ...
              <p>Lorem ipsum dolor sit amet consectetur. Aliquet suspendisse elementum feugiat sit vel scelerisque. Pellentesque elit purus vel viverra rhoncus. Tempus eget dolor feugiat porttitor. Et gravida tortor vel venenatis varius odio vivamus. Quam sed egestas amet vel. Sed et viverra leo in pellentesque varius. </p>
    ...
    ===============================-->
    <section class="tf__student_choose pt_120 xs_pt_80 pb_115 xs_pb_75" style="background: url(images/student_choose_bg.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1s">
            <div class="tf__student_choose_text">
              ...
              <p>Lorem ipsum dolor sit amet consectetur. Posuere vulputate at tortor aenean tortor tincidunt dui consequat enim. Vel iaculis euismod et scelerisque condimentum nulla cras. Praesent diam orci id et eu nulla id. Auctor fermentum.</p>
              <ul>
