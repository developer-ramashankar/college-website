...
if(isset($_POST['submit']))
{
	...
	{	
		...
		if (file_exists("../content/blogs/" . $newfilename))  //Change FIle Root Only   //Folder Name
		{
		...
		{		
			move_uploaded_file($_FILES["photo"]["tmp_name"], "../content/blogs/" . $newfilename); //Change FIle Name & Root Only
...
$photo='content/blogs/'.$newfilename;
	...
	//Getting data from form
			...
			$sql = "insert into add_blog (id,title,writer,detail,date,photo) values ('id','$title','$writer','$detail','$date','$photo')";
