            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h5 class="mt-4">Add Teacher <a href="./teacherlist.php"><button class="btn btn-primary btn-sm">Teacher List</button></a></h5>
						...
						<?php } ?>
							...
							<form method="post" enctype="multipart/form-data" action="./addteacher.php">
											...
											<div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail"  name="post" type="text" placeholder="name@example.com" />
