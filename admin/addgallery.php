            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h5 class="mt-4">Add Gallery <a href="./gallerylist.php"><button class="btn btn-primary btn-sm">Gallery List</button></a></h5>
						...
						<?php } ?>
							...
							<form method="post" enctype="multipart/form-data" action="./addgallery.php">
                                            <div class="row mb-3"> 
                                                  <div class="col-md-6">
