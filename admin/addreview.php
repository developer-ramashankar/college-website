...
if(isset($_POST['submit']))
{
	...
	{	
		...
		if (file_exists("../content/review/" . $newfilename))  //Change FIle Root Only   //Folder Name
		{
		...
		{		
			move_uploaded_file($_FILES["photo"]["tmp_name"], "../content/review/" . $newfilename); //Change FIle Name & Root Only
...
$photo='content/review/'.$newfilename;
	...
	//Getting data from form
			...
			$sql = "insert into review (id,name,detail,photo) values ('id','$name','$detail','$photo')";
			
			
			if ($conn->query($sql) === TRUE) {
			  
			  header('location:./addreview.php?msg=Successfully Uploaded.');
  ...
  <body class="sb-nav-fixed"> <?php include('./header.php'); ?> <div id="layoutSidenav"> <?php include('./menu.php'); ?> <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h5 class="mt-4">Add Review <a href="./reviewlist.php">
                <button class="btn btn-primary btn-sm">Review List</button>
              </a>
            </h5>
            <div class="row"> <?php if(isset($_GET['msg'])) { ?> <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Hey Admin!</strong> You Have Successfully Uploaded Review. <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div> <?php } ?> <form method="post" enctype="multipart/form-data" action="./addreview.php">
                <div class="row mb-3">
                  <div class="form-floating">
                    <div class="form-floating mb-3 mb-md-0">
                      <input class="form-control" id="inputFirstName" name="name" type="text" required placeholder="Enter your first name" />
