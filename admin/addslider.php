...
if(isset($_POST['submit']))
{
	...
	{	
		...
		if (file_exists("../content/slider/" . $newfilename))  //Change FIle Root Only   //Folder Name
		{
		...
		{		
			move_uploaded_file($_FILES["photo"]["tmp_name"], "../content/slider/" . $newfilename); //Change FIle Name & Root Only
...
$photo='content/slider/'.$newfilename;
		...
		include('./db.php');
			...
			$sql = "insert into home_slider (id,photo) values ('id','$photo')";
