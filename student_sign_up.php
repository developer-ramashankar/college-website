<?php
	...
	{	
		...
		$sql = "insert into student_login (id,name,class,email,mobile,pass,date,datetime) values ('id','$name','$class','$email','$mobile','$pass','$date','$datetime')";
		
		
		

		if ($conn->query($sql) === TRUE) {
		    header('location:./student_sign_up.php?msg=Successfully Sign Up.');
...
<html lang="en">
  <head>
    ...
    <title>SNSY Inter College - Student Sign Up</title> <?php include("./include/stylesheet.php")?>
  </head>
            ...
            <div class="row">
                <div class="col-xl-5 col-md-9 col-lg-7 m-auto wow fadeInUp" data-wow-duration="1s">
                    <div class="tf__sing_in_form">
                                ...
                                <div class="col-xl-12">
								  ...
								  <div class="col-xl-12">
                                    <div class="tf__form_single_input">
										...
										<option>Enter Your Class</option>
										<option>12th</option>
										<option>11th</option>
										<option>10th</option>
										<option>9th</option>
                        ...
                        <p class="create_account">Dont’t have an aceount ? <a href="student_login.php">Login</a>
                        </p>
                    </div>
                </div>
            </div>
