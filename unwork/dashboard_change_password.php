...
<!-- Mirrored from html.themefax.com/edufax/dashboard_change_password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 07:03:42 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
...
<body>
    ...
    <!--==============================
    DASHBOARD CHANGE PASSWORD PAGE START
    ===============================-->
                        ...
                        <div class="tf__dashboard_sidebar">
                            ...
                            <div class="tf__dashboard_sidebar_menu">
                                <ul>
                                    ...
                                    <li><a class="active" href="dashboard_change_password.html"><i
                                                class="far fa-lock"></i> Change
                                            Password</a></li>
    ...
    <!--==============================
    DASHBOARD CHANGE PASSWORD PAGE END
    ===============================-->
