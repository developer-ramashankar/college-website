                ...
                <div class="row">
                            ...
                            <div class="tf__dashboard_sidebar_menu">
                                <ul>
                                    <li><a href="dashboard.html"><i class="far fa-th-large"></i>
                                            Overview</a></li>
                                    <li><a class="active" href="dashboard_info.html"><i class="far fa-user"></i>
                                            Personal Info</a></li>
                    ...
                    <div class="col-xxl-9 col-lg-8">
                        <div class="tf__dashboard_body">
                            <h2 class="dashboard_title">Personal Information <a href="dashboard_info_edit.html">edit</a>
                            </h2>
                            <div class="tf__dashboard_info wow fadeInUp" data-wow-duration="1s">
                                <ul>
                                    <li><span>Name</span><b>:</b> Jhon Due</li>
                                    <li><span>email</span><b>:</b> jhon.due@gmail.com</li>
                                    <li><span>phone</span><b>:</b> +123 324 543</li>
                                    <li><span>address </span><b>:</b> 4517 Washington Ave. Manchester, Kentucky 39495
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<!-- Mirrored from html.themefax.com/edufax/dashboard_info.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 07:03:41 GMT -->
</html>