...
<!-- Mirrored from html.themefax.com/edufax/dashboard_wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 07:03:42 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
                ...
                <div class="row">
                        ...
                        <div class="tf__dashboard_sidebar">
                            ...
                            <div class="tf__dashboard_sidebar_menu">
                                <ul>
                                    ...
                                    <li><a class="active" href="dashboard_wishlist.html"><i class="far fa-heart"></i>
                                            Wishlist</a></li>
                    ...
                    <div class="col-xxl-9 col-lg-8">
                        <div class="tf__dashboard_body">
                            ...
                            <div class="tf__dashboard_wishlist">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6 wow fadeInUp" data-wow-duration="1s">
                                        <div class="tf__single_courses">
                                            ...
                                            <ul
                                                class="tf__single_courses_footer d-flex flex-wrap justify-content-between">
                                                <li>
                                                    <span>
                                                ...
                                                <li>
                                                    <span>
                                                        <img src="images/doller_icon.svg" alt="user"
                                                            class="img-fluid w-100">
                                                    </span>
                                                    80.00
                                                </li>
                                    ...
                                    <div class="col-xl-6 col-md-6 wow fadeInUp" data-wow-duration="1s">
                                        <div class="tf__single_courses">
                                            <div class="tf__single_courses_img">
                                                <img src="images/courses_img_4.jpg" alt="courses"
                                                    class="img-fluid w-100">
