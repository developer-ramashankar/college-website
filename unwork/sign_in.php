...
<!-- Mirrored from html.themefax.com/edufax/sign_in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 07:03:42 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
            ...
            <div class="row">
                <div class="col-xl-5 col-md-9 col-lg-7 m-auto wow fadeInUp" data-wow-duration="1s">
                    <div class="tf__sing_in_form">
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <button type="submit" class="tf__common_btn">Sign in</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <p class="create_account">Dont’t have an aceount ? <a href="sign_up.html">sign up</a>
                        </p>
                    </div>
                </div>
            </div>
