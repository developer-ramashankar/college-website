                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="./detail.php">
					...
					<div class="form-group">
                      ...
                      <select class="form-select" name="sub_1" id="sub_1" aria-label="Default select example" required>
					 ...
					 <div class="form-group">
                      ...
                      <select class="form-select" name="sub_5"  required>
					  <option selected>Select Subject</option>
                    ...
                    <button type="submit" name="submit" class="btn btn-primary me-2">Submit</button>
					 <!--  <a href="./edit_detail.php?mobile=<?php echo $row['mobile']; ?>&action=edit"><button class="btn btn-danger me-2">Update</button></a> -->
