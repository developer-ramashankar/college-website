...
$sql = "SELECT * from student_login where mobile='$mobile' and pass='$pass'";
...
if($count==1)
{
	...
	header('location:./student_panal/index.php');
}
else
{
	header('location:./student_login.php?msg=Wrong Mobile Or Pass');
}
            ...
            <div class="row">
                <div class="col-xl-5 col-md-9 col-lg-7 m-auto wow fadeInUp" data-wow-duration="1s">
                    <div class="tf__sing_in_form">
                        ...
                        <p class="create_account">Dont’t have an aceount ? <a href="student_sign_up.php">sign up</a>
                        </p>
                    </div>
                </div>
            </div>
