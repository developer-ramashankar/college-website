...
<!-- Mirrored from html.themefax.com/edufax/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 07:03:38 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="tf__faq_text">
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item wow fadeInUp" data-wow-duration="1s">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <p>Yes, you can try us for free for 30 days. If you want, we’ll provide you with
                                            a free, personalized 30-minute onboarding call to get you up and running as
                                            soon as possible. you can try us for free for 30 days. If you want, we’ll
                                            provide you with a free, personalized 30-minute onboarding.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item wow fadeInUp" data-wow-duration="1s">
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-duration="1s">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseThree111" aria-expanded="false"
                                        aria-controls="collapseThree111">
                                        How do I Make a Premium User?
                                    </button>
                                </h2>
                                <div id="collapseThree111" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Yes, you can try us for free for 30 days. If you want, we’ll provide you with
                                            a free, personalized 30-minute onboarding call to get you up and running as
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-duration="1s">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseThree1111" aria-expanded="false"
                                        aria-controls="collapseThree1111">
                                        How to Purchase a Course?
                                    </button>
                                </h2>
                                <div id="collapseThree1111" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>Yes, you can try us for free for 30 days. If you want, we’ll provide you with
                                            a free, personalized 30-minute onboarding call to get you up and running as
                ...
                <div class="col-xxl-4 col-lg-5 wow fadeInRight" data-wow-duration="1s">
                    <form class="tf__faq_form tf__become_instructor_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <button type="submit" class="tf__common_btn">Become an Instructor</button>
                            </div>
                        </div>
                    </form>
                </div>
